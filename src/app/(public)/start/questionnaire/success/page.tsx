  ...
  useEffect(() => {
    const fetchReceiptData = async () => {
      ...
      try {
        ...
        // Map service types (both friendly names and enum values) to package tiers for receipt display
        const serviceTypeToPackage: Record<string, string> = {
          // Friendly names
          'marketing-website': 'pro',
          'e-commerce-store': 'elite',
          'web-application': 'elite',
          'landing-page': 'starter',
          'maintenance': 'pro',
          'quick-fix': 'starter',
          // Enum values from database
          'business_website': 'pro',
          'nonprofit_website': 'pro',
          'maintenance_plan': 'pro',
          'ecommerce': 'elite',
          'web_app': 'elite',
        };
        ...
        const serviceType = lead.serviceType?.toLowerCase().replace(/-/g, '_') || 'business_website';
        const mappedPackage = serviceTypeToPackage[serviceType] || 'pro'; // Default to pro
        
        const receiptData = {
          package: metadata.package || mappedPackage,
          name: lead.name || '',
          email: lead.email || '',
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center p-4 py-20">
          ...
          >
            ...
            <div className="text-center mb-12">
              ...
              >
                That's exciting! 🎉 An admin will review your project request and get back to you within 24 hours.
              </motion.p>
