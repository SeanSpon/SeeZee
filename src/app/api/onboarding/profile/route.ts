...
export async function POST(req: Request) {
  try {
    ...
    // REMOVED: Duplicate Lead creation logic
    // Leads should only be created through the intake form (api/leads/submit)
    // Creating leads here caused duplicate entries when users completed profiles
