...
import { calculateTotals, formatPrice } from '@/lib/qwiz/pricing';
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-0 left-0 right-0 z-20 backdrop-blur-xl bg-black/30 border-t border-white/10"
      >
