export function Services() {
  return (
    <section id="services" className="py-20 bg-transparent backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="hover:scale-105 transition-transform fade-in bg-white/8 backdrop-blur-xl rounded-2xl p-6 shadow-[0_0_40px_rgba(124,92,255,0.05)]">
