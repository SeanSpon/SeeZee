...
import { CreditCard, Package, AlertCircle, DollarSign, TrendingUp, Server, Receipt, Sparkles } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-xl p-8">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-2xl font-semibold text-white mb-2">Welcome to Your Client Portal!</h2>
            <p className="text-gray-300 mb-6">
              You have full access to the client portal. Your initial project build includes everything you need to get started.
              When you're ready, you can add a maintenance plan for ongoing support, updates, and additional hours.
            </p>
            <div className="flex gap-3 justify-center flex-wrap">
              <Link
                href="/client/hours#select-plan"
                className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white rounded-lg font-medium transition-colors inline-flex items-center gap-2"
              >
              ...
              <Link
                ...
                className="px-6 py-3 bg-white/10 hover:bg-white/20 border border-white/20 text-white rounded-lg font-medium transition-colors inline-flex items-center gap-2"
              >
                Submit a Request
              </Link>
            </div>
