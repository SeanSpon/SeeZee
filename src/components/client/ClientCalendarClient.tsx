...
import { format, startOfMonth, endOfMonth, startOfWeek, endOfWeek, eachDayOfInterval, isSameMonth, isSameDay, isToday, addMonths, subMonths, startOfDay } from "date-fns";
...
export function ClientCalendarClient({
  ...
  // Get calendar days
  // Create a full calendar grid by starting from the week containing the first day of the month
  // and ending at the week containing the last day of the month
