...
export default function ToolCreateModal({
  isOpen,
  onClose,
  onSuccess,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("/api/ceo/tools", {
        method: "POST",
      ...
      toast(err.message || "Failed to create tool", "error");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-400 mt-1">
                Add a new tool to the company directory
              </p>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-[1fr,auto] gap-4">
            ...
            <div className="w-24">
              ...
              <input
                ...
                placeholder="🎨"
                maxLength={2}
                className="w-full px-4 py-2 bg-slate-800/50 border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-center text-2xl"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">
              Link to the tool's website or login page
            </p>
          </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={loading || !name.trim() || !category || !url.trim()}
